...
{"name":"TitleCommandExit","status":true,"description":"UNICORNS I LOVE THEM Adds an option in the title command window to close\r\ngame window.","parameters":{"Command Exit":"Exit","Show Exit":"true"}}
];
